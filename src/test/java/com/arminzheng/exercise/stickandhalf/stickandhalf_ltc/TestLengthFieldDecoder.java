package com.arminzheng.exercise.stickandhalf.stickandhalf_ltc;
 ...
 * <p>案例1
 *
 * <p>注意：内容读完后，再读到字节就当成 Length 如果不规范会报错
 *
 * <pre>
 ...
 *  * </pre>
 *
 * LengthFieldBasedFrameDecoder( int maxFrameLength, 限制最大长度，超过他没找到分隔符报错 int lengthFieldOffset, 长度字段
 * 偏移量 int lengthFieldLength, 长度字段 本身长度 int lengthAdjustment, 长度字段 为基准，跳过几个字节 才是内容 int
 * initialBytesToStrip 从头玻璃 几个字节，解析后将不出现 )
 *
 * <p>#################### 案例2 【从头剥离几个字节】 ############ *
 *
 * <pre>
...
public class TestLengthFieldDecoder {
    ...
    public static void main(String[] args) {
        ...
        final EmbeddedChannel ch =
                new EmbeddedChannel(
                        // 注意：解码器 放debug上面
                        new LengthFieldBasedFrameDecoder(1024, 0, 4, 3, 0),
