...
import com.arminzheng.infrastructure.utility.ConvertUtil;
...
public class ByteBufUnpooledTest {
    ...
    public void test0() {
        ...
        System.out.println(buf1.getClass()); // : class
        // io.netty.buffer.UnpooledByteBufAllocator$InstrumentedUnpooledUnsafeHeapByteBuf   非池化堆内存
        System.out.println(
                buf2.getClass()); // : class io.netty.buffer.PooledUnsafeDirectByteBuf     池化直接内存
        // 非池化堆内存 进行零拷贝
    ...
    public void test2() {
        ...
        //        final String v =
        // ConvertUtil.hexString2String(ByteBufUtil.hexDump(dataBuf.readBytes(5)));
        //
        //        // 类型连接
        //        final String tsUtf8 =
        // ConvertUtil.toStringHex2(ByteBufUtil.hexDump(dataBuf.readBytes(dataBuf.readableBytes()-1)));
